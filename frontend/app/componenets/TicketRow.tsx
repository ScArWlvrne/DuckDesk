  ...
  return (
    <div className="basis-0 content-stretch flex gap-[4px] grow h-[32px] items-center justify-center min-h-px min-w-px relative shrink-0">
      <div className="content-stretch flex flex-col gap-[8px] h-[32px] items-start relative shrink-0 w-[114px]" data-name="Text Content Heading">
        <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.2] not-italic relative shrink-0 text-[#007030] text-[24px] tracking-[-0.48px] w-full">{ticket.id}</span>
      </div>
...
function Card({ ticket }: { ticket: Ticket }) {
  ...
  return (
    <div 
      className="bg-white h-[77px] min-w-[240px] relative shrink-0 w-full cursor-pointer hover:bg-gray-50 transition-colors" 
      data-name="Card"
      onClick={handleClick}
    >
